...
const mockInterviews = [
  ...
  },
  {
    ...
    type: "in-person",
    notes: "Completed initial interview. Candidate has strong skills in French cuisine.",
    status: "completed"
  },
  {
    id: "int5",
    ...
    type: "video",
    notes: "Candidate has excellent customer service experience.",
    status: "completed"
  }
];

export default function RestaurantInterviews() {
  ...
  return (
    <ErrorBoundary>
      <Head>
        <title>Scheduled Interviews | StaffSpace</title>
        <meta name="description" content="Manage your scheduled interviews with job candidates on StaffSpace." />
      </Head>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Manage your interviews with job candidates
              </p>
            </div>
          </div>
          <Button 
            onClick={() => safeNavigate("/restaurant/schedule-interview")}
            disabled={isNavigating}
          >
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm font-medium mb-2">Candidate: {interview.candidateName}</p>
                      {interview.notes && (
                    ...
                    <div className="flex flex-col gap-2 self-end md:self-start">
                      <div className="flex gap-2">
                        <Button 
                          variant="outline" 
                          size="sm"
                          onClick={() => safeNavigate(`/messaging?conversation=${interview.candidateName}`)}
                          disabled={isNavigating}
                          className="w-full"
                        >
                      ...
                      <Button 
                        size="sm"
                        onClick={() => safeNavigate(`/restaurant/interviews/${interview.id}`)}
                        disabled={isNavigating}
                        className="w-full"
                      >
                        View Details
