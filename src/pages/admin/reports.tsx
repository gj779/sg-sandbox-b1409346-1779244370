...
export default function AdminReports() {
  ...
  return (
    <>
      <Head>
        <title>Reports | Admin Dashboard | StaffSpace</title>
        <meta name="description" content="View and manage reports on the StaffSpace platform" />
      </Head>
      ...
      <div className="container py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground">
              View and manage platform reports and analytics
            </p>
          </div>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>The reports feature is currently under development and will be available soon.</p>
            <p className="mt-4">This page will include:</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>User activity reports</li>
              <li>Job posting analytics</li>
              <li>Application conversion metrics</li>
