...
/**
 * Hook for tracking a specific user's presence
 ...
 */
export function useMultipleUsersPresence(userIds: (string | null | undefined)[]) {
...
/**
 * Main presence hook for initializing and managing user presence
 */
